...
function! InsertStatuslineColor(mode)
  if a:mode == 'i'
  hi statusline guibg=red guifg=white cterm=underline,bold 
elseif a:mode == 'r'
    hi statusline guibg=green guifg=white cterm=underline,bold
  else
    hi statusline guibg=blue guifg=white cterm=underline,bold
  endif
endfunction

au InsertEnter * call InsertStatuslineColor(v:insertmode)
au InsertChange * call InsertStatuslineColor(v:insertmode)
au InsertLeave * hi statusline guibg=#0777c7 guifg=white

" default the statusline when entering Vim
  hi statusline guibg=#0777c7 guifg=white cterm=underline,bold 
" -----------------------------------------------------------------------------
" Basic Settings
